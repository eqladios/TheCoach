...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { htmlBody: @slide.htmlBody, topic_id: @slide.topic_id } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { htmlBody: @slide.htmlBody, topic_id: @slide.topic_id } }
