...
class ProblemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post problems_url, params: { problem: { content: @problem.content, name: @problem.name, section_id: @problem.section_id } }
    end
  ...
  test "should update problem" do
    patch problem_url(@problem), params: { problem: { content: @problem.content, name: @problem.name, section_id: @problem.section_id } }
